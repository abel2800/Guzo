...
export const styles = StyleSheet.create({
  ...
  input: { backgroundColor: theme.bg, borderWidth: 1, borderColor: theme.border, borderRadius: 12, padding: 14, color: theme.text, fontSize: 16, marginBottom: 12 },
  btn: { backgroundColor: theme.primary, borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 8 },
  btnOutline: { backgroundColor: 'transparent', borderWidth: 1, borderColor: theme.border, borderRadius: 14, padding: 16, alignItems: 'center', marginTop: 8 },
  btnText: { color: theme.bg, fontWeight: '700', fontSize: 16 },
  btnTextOutline: { color: theme.text, fontWeight: '600', fontSize: 16 },
  badge: { alignSelf: 'flex-start', backgroundColor: 'rgba(34,197,94,0.15)', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 999 },
