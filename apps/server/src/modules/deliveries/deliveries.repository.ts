...
/**
 * Repository for deliveries. Generic CRUD over the Prisma "delivery" delegate.
...
const delegate = (prisma as any).delivery;
...
export class DeliveryRepository {
  async list(params: DeliveryListParams) {
    const searchFields = ["recipientName"];
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export const deliveriesRepository = new DeliveryRepository();
