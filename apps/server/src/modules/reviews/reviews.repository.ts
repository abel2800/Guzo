...
/**
 * Repository for reviews. Generic CRUD over the Prisma "review" delegate.
...
const delegate = (prisma as any).review;
...
export const reviewsRepository = new ReviewRepository();
