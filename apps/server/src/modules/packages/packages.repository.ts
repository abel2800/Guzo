...
/**
 * Repository for packages. Generic CRUD over the Prisma "package" delegate.
...
const delegate = (prisma as any).package;
...
export class PackageRepository {
  async list(params: PackageListParams) {
    const searchFields = ["trackingNumber","barcode"];
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export const packagesRepository = new PackageRepository();
