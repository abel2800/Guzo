...
/**
 * Repository for settings. Generic CRUD over the Prisma "setting" delegate.
...
const delegate = (prisma as any).setting;
...
export class SettingRepository {
  async list(params: SettingListParams) {
    const searchFields = ["key"];
    // eslint-disable-next-line @typescript-eslint/no-explicit-any
...
export const settingsRepository = new SettingRepository();
