...
export function FloatingTabBar({ state, navigation, tabs }: BottomTabBarProps & { tabs: TabConfig[] }) {
...
const styles = StyleSheet.create({
  container: { position: 'absolute', left: 0, right: 0, bottom: 0, alignItems: 'center', paddingHorizontal: 20 },
  pill: {
    width: '100%',
    maxWidth: 400,
  ...
  row: { flexDirection: 'row', justifyContent: 'space-around', paddingVertical: 10, paddingHorizontal: 8 },
  tab: { alignItems: 'center', flex: 1, paddingVertical: 4 },
  iconWrap: { width: 44, height: 36, alignItems: 'center', justifyContent: 'center', borderRadius: radius.pill },
  iconWrapActive: { backgroundColor: 'rgba(34,197,94,0.12)' },
  glow: { ...StyleSheet.absoluteFillObject, borderRadius: radius.pill, backgroundColor: 'rgba(34,197,94,0.08)' },
